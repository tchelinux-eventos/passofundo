[![Tchelinux 2020 Passo Fundo](images/banner.jpg)](#)
...
<center><a href="https://passofundo.tchelinux.org/inscricoes/" style="color:#ff4040"><b><h3>Clique aqui e faça já a sua inscrição! Vagas limitadas!<h3></b></a></center>
...
| <center> Horário </center> | <center> Sala 1 <br> Desenvolvimento </center> | <center> Sala 2 <br> DevOps e Segurança </center> | <center> Sala 303 <br> Distro e Comunidade </center> |
|:--------------------------:|:-----------------------:|:-----------------------:|:-----------------------:|
...
| **9:30** | [**Persistência de Dados no Flutter**](#Persistência_de_Dados_no_Flutter) <br> <span class="label label-warning">Intermediário</span> <br> Ricardo da Silva Ogliari | [**Explorando o GIT com Lego**](#Explorando_o_GIT_com_Lego) <br> <span class="label label-success">Principiante</span> <br>  William Barrilli | [**Precisamos falar sobre o Debian, O sistema Operacional Universal**](#Precisamos_falar_sobre_o_Debian,_O_sistema_Operacional_Universal) <br> <span class="label label-success">Principiante</span> <br> José Antônio Oliveira de Figueiredo |
| **10:20** | [**História do JavaScript**](#História_do_JavaScript) <br> <span class="label label-success">Principiante</span> <br> Guilherme Zordan | [**Projeto Katello, gerenciando ciclo de vida de servidores**](#Projeto_Katello,_gerenciando_ciclo_de_vida_de_servidores) <br> <span class="label label-warning">Intermediário</span> <br> Rudnei Bertol Junior | [**Middleware ROS**](#Middleware_ROS) <br> <span class="label label-success">Principiante</span> <br> Daniel Nicolau Saito |
| **11:10** | [**Organizando o frontend para projetos de larga escala**](#Organizando_o_frontend_para_projetos_de_larga_escala) <br> <span class="label label-warning">Intermediário</span> <br> Jaison Schmidt | [**BDD, do conceito a execução**](#BDD,_do_conceito_a_execução) <br> <span class="label label-success">Principiante</span> <br> Hiago Adão | [**Beacons e as aplicações web físicas**](#Beacons_e_as_aplicações_web_físicas) <br> <span class="label label-success">Principiante</span> <br> Fernando Posser Pinheiro |
| **12:00** <td colspan=4><center>**Intervalo para Almoço**</center> |
| **13:30** | [**Migrando do complexo Java para a simplicidade do Kotlin**](#Migrando_do_complexo_Java_para_a_simplicidade_do_Kotlin) <br> <span class="label label-success">Principiante</span> <br> Filipe Francisco Nunes | [**Como montar e publicar seu primeiro site na internet usando ferramentas gratuitas**](#Como_montar_e_publicar_seu_primeiro_site_na_internet_usando_ferramentas_gratuitas) <br> <span class="label label-success">Principiante</span> <br> Vinicius A. Lucas | [**Se fosse fácil, não seria legal!**](#Se_fosse_fácil,_não_seria_legal!) <br> <span class="label label-success">Principiante</span> <br> Luciano Camargo Cruz |
| **14:20** | [**Redes Neurais Convolucionais e Visão Computacional para o Reconhecimento de Objetos em Imagens**](#Redes_Neurais_Convolucionais_e_Visão_Computacional_para_o_Reconhecimento_de_Objetos_em_Imagens) <br> <span class="label label-warning">Intermediário</span> <br> Telmo De Cesaro Júnior | [**PWNED! Meu site foi invadido, e agora?**](#PWNED!_Meu_site_foi_invadido,_e_agora?) <br> <span class="label label-warning">Intermediário</span> <br> Fabio Beneditto | [**GeoStack**](#GeoStack) <br> <span class="label label-warning">Intermediário</span> <br> Gustavo Castro e Josué Lino Bragagnolo |
| **15:10** | [**Desenvolvendo jogos com Python e pygame**](#Desenvolvendo_jogos_com_Python_e_pygame) <br> <span class="label label-success">Principiante</span> <br>  Rafael Guterres Jeffman  | [**Assistentes virtuais com IA utilizando RASA**](#Assistentes_virtuais_com_IA_utilizando_RASA) <br> <span class="label label-warning">Intermediário</span> <br> Gustavo Castro  | [**Tudo que você queria saber sobre a LGPD e não sabia pra quem perguntar!**](#Tudo_que_você_queria_saber_sobre_a_LGPD_e_não_sabia_pra_quem_perguntar!) <br> <span class="label label-warning">Intermediário</span> <br> Marcos A. Lucas |
| **16:00** <td colspan=4><center>**Coffee-Break**</center> |
...
[**Hiago Adão**](http://linkedin.com/in/hiago-adão-müller-oliveira-b223b1161) é Desenvolvedor Python e React na metodologia ágil a 1 ano e estudante de ciência da computação.
...
Vou falar sobre como o mercado está aquecido na area de tecnologia. Conversar sobre novas tecnologias, trabalho remoto e muitas outras coisas legais.
